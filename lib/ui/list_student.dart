...
import 'package:firebase_crud/ui/student_screen.dart';
import 'package:firebase_crud/ui/student_information.dart';
...
class listStat extends State<ListStudent>
{
                  ...
                  Row(
                    children: <Widget>[
                            ...
                            leading: Column(
                              children: <Widget>[
                                CircleAvatar(
                                  ...
                                  radius: 14.0,
                                  child: Text('${pos + 1}',style: TextStyle(color: Colors.black ,fontSize:8.0),),
                                ),


                              ],
                            ),
                            onTap: () => navInfo(context , items[pos]) ,
                      ...
                      IconButton(
                          ...
                          onPressed: () =>navStud(context , items[pos])
                      )
  ...
  void navInfo(BuildContext context , Student student) async
  {
    await Navigator.push(context,
